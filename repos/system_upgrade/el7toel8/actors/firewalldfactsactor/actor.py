...
class FirewalldFactsActor(Actor):
    ...
    def process(self):
        ...
        try:
            ...
            root = tree.getroot()
            facts.firewall_config_command = firewalldfactsactor.getLockdownFirewallConfigCommand(
                root
            )
        except IOError:
            pass
        ...
        try:
            ...
            root = tree.getroot()
            facts.ebtablesTablesInUse = firewalldfactsactor.getEbtablesTablesInUse(
                root
            )
        except IOError:
            pass
        ...
        try:
            for filename in os.listdir(directory):
                ...
                try:
                    ...
                    root = tree.getroot()
                    ipsetTypesInUse |= set(
                        firewalldfactsactor.getIpsetTypesInUse(root)
                    )
                except IOError:
                    pass
