from leapp.libraries.actor import (
    spamassassinconfigread_spamc,
    spamassassinconfigread_spamd,
)
...
def get_spamassassin_facts(read_func, listdir):
    ...
    """
    spamc_ssl_argument = spamassassinconfigread_spamc.get_spamc_ssl_argument(
        read_func
    )
    service_overriden = spamassassinconfigread_spamd.spamassassin_service_overriden(
        listdir
    )
    spamd_ssl_version = spamassassinconfigread_spamd.get_spamd_ssl_version(
        read_func
    )
    return SpamassassinFacts(
        spamc_ssl_argument=spamc_ssl_argument,
