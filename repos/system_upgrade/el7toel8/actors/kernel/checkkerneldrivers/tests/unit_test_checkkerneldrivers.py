...
from leapp.models import KernelModuleParameter, PCIDevice, PCIDevices
...
devices_driverless = [
    PCIDevice(
        slot='00:04.0', dev_cls='foo', vendor='bar', name='foobar', driver=''
    ),
    PCIDevice(
        slot='00:05.0', dev_cls='foo', vendor='bar', name='foobar', driver=''
    ),
]
devices_removed = [
    PCIDevice(
