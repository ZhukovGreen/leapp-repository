...
def test_get_daemon_lists_in_file():
    ...
    daemon_lists = tcpwrappersconfigread._get_daemon_lists_in_file(
        path, read_func=reader.read
    )
...
def test_get_daemon_lists_in_file_nonexistent():
    reader = MockFileReader()
    daemon_lists = tcpwrappersconfigread._get_daemon_lists_in_file(
        '/etc/hosts.allow', read_func=reader.read
    )
