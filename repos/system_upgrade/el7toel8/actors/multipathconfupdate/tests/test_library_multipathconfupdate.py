...
default_rhel7_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/default_rhel7.conf'),
        'directio',
...
all_devs_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/all_devs.conf'),
        None,
        None,
        None,
        None,
...
empty_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/empty.conf'),
        None,
        None,
        None,
        None,
...
default_rhel8_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/default_rhel8.conf'),
        'tur',
...
all_the_things_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/all_the_things.conf'),
        'directio',
        os.path.join(CUR_DIR, 'files/conf.d'),
        False,
        False,
...
already_updated_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/already_updated.conf'),
        None,
        os.path.join(CUR_DIR, 'files/conf.d'),
        None,
        None,
...
ugly1_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/ugly1.conf'),
        'directio',
        os.path.join(CUR_DIR, 'files/conf.d'),
        False,
        False,
...
ugly2_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/ugly2.conf'),
        None,
        None,
        None,
        None,
...
just_checker_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/just_checker.conf'),
        'rdac',
        '/etc/multipath/conf.d',
        True,
        True,
...
just_detect_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/just_detect.conf'),
        None,
        None,
        None,
        False,
...
just_reassign_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/just_reassign.conf'),
        None,
        None,
        None,
        None,
...
just_exists_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/just_exists.conf'),
        None,
        None,
        None,
        None,
...
just_all_devs_conf = build_config(
    [
        os.path.join(CUR_DIR, 'files/before/just_all_devs.conf'),
        None,
        None,
        None,
        None,
